...
public class SignInActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnlogin =  findViewById(R.id.sign_in_email);
        TextView btnGoToSignUp = findViewById(R.id.btnGoToSignUp);
        SignInButton btnSignInGoogle = findViewById(R.id.sign_in_google);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(SignInActivity.this, "Fallo de autenticación", Toast.LENGTH_SHORT).show();
                            //updateUI(null);
                        }
                    }
                });
